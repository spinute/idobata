  ...
  const themesData = [
    {
      ...
      description: "若者の雇用不安や将来への不安を解消し、安心してキャリアを築ける社会の実現について議論します。",
      keyQuestionCount: 12,
      commentCount: 45,
    },
    {
      ...
      description: "子育て世代が抱える経済的・時間的負担や、保育・教育の問題について考えます。",
      keyQuestionCount: 8,
      commentCount: 32,
    },
    {
      ...
      description: "高齢化が進む地域での支え合いや、コミュニティ再生のアイデアを集めます。",
      keyQuestionCount: 10,
      commentCount: 28,
    },
    {
      ...
      description: "デジタル化が進む中で、個人情報の保護と利便性をどうバランスさせるかを考えます。",
      keyQuestionCount: 6,
      commentCount: 19,
    },
    {
      ...
      description: "環境に配慮しつつ、安定したエネルギー供給を実現するための政策について議論します。",
      keyQuestionCount: 9,
      commentCount: 27,
    },
  ];
